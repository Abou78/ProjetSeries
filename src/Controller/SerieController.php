...
class SerieController extends AbstractController
{
    ...
    {
        $serie = new Serie();
        // Ajout de la date de création car supprimer dans le formulaire et ne peut pas être vide
